...
>
QCU_DEVICE
void single_point_wilson_dslash_t_forward_ghost_unpack(
...
>
QCU_DEVICE
void single_point_wilson_dslash_t_backward_ghost_unpack(
    FloatType_* __restrict__ out,
    FloatType_* __restrict__ temp_in,
    QcuLattDesc latt_desc, int ghost_dim , int parity,
    bool dagger_flag, int n_color, int m_rhs, int coord_1dim)
    ...
    int parity, bool dagger_flag, int n_color, int m_rhs)
{
    ...
    for (int idx = block_id; idx < half_vol; idx += grid_size) {
        single_point_wilson_dslash_t_forward_ghost_unpack<FloatType_, BlockShape_, WarpShape_>(
    ...
    int parity, bool dagger_flag, int n_color, int m_rhs)
{
    ...
    for (int idx = block_id; idx < half_vol; idx += grid_size) {
        single_point_wilson_dslash_t_backward_ghost_unpack<FloatType_, BlockShape_, WarpShape_>(
