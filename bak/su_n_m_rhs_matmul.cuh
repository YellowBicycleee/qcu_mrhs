...
//     }  // for i : K_TILES
//     // store to smem_R
//     wmma::store_matrix_sync(smem_R, R1_real_frag, WMMA_N, wmma::mem_row_major);                        // R1_real
//     wmma::store_matrix_sync(smem_R + WMMA_M * WMMA_N, R1_imag_frag, WMMA_N, wmma::mem_row_major);      // R1_imag
...
//     // acc to smem_L    TODO
//     calc_L_from_R1(smem_L, smem_R, WMMA_M, WMMA_N, X_DIM + 1, dagger_flag);
//     calc_L_from_R2(smem_L, smem_R, WMMA_M, WMMA_N, X_DIM + 1, dagger_flag);
// }

// template <typename Float>
// __device__ void x_dim_bwd_dir(Float* __restrict__ smem_mat_L, Float* __restrict__ smem_mat_U,
//                               Float* __restrict__ smem_mat_R, Float* __restrict__ smem_mat_T,
//                               Float* __restrict__ global_gauge, Float* __restrict__ global_fermion_in, bool dagger_flag,
//                               int n_color, int m_rhs, int warp_begin_row, int warp_begin_col) {
//     // clang-format on
//     using Float2 = typename Float2Wrapper<Float>::Float2;
//     constexpr int WMMA_M = WMMA_Param<Float>::WMMA_M;
//     constexpr int WMMA_N = WMMA_Param<Float>::WMMA_N;
...
// template <typename Float>
// __device__ void dslash_fwd_dir(Float* __restrict__ smem_mat_L, Float* __restrict__ smem_mat_U,
//                                Float* __restrict__ smem_mat_R, Float* __restrict__ smem_mat_T,
//                                Float* __restrict__ global_gauge, Float* __restrict__ global_fermion_in,
//                                bool dagger_flag, int n_color, int m_rhs, int warp_begin_row, int warp_begin_col,
//                                int dim) {
...
//     wmma::store_matrix_sync(smem_R + 3 * WMMA_M * WMMA_N, R2_imag_frag, WMMA_N, wmma::mem_row_major);  // R2_imag
//     // acc to smem_L    TODO
//     calc_L_from_R1(smem_L, smem_R, WMMA_M, WMMA_N, dim + 1, dagger_flag);
//     calc_L_from_R2(smem_L, smem_R, WMMA_M, WMMA_N, dim + 1, dagger_flag);
// }

// template <typename Float>
// __device__ void dslash_bwd_dir(Float* __restrict__ smem_mat_L, Float* __restrict__ smem_mat_U,
//                                Float* __restrict__ smem_mat_R, Float* __restrict__ smem_mat_T,
//                                Float* __restrict__ global_gauge, Float* __restrict__ global_fermion_in,
//                                bool dagger_flag, int n_color, int m_rhs, int warp_begin_row, int warp_begin_col,
//                                int dim) {
