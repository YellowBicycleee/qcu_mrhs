                    ...
                    int max_iteration, double max_precision)
{
    ...
    if (outputPrecision == QcuPrecision::kPrecisionDouble && iteratePrecision == QcuPrecision::kPrecisionDouble) {
        BiCGStabImpl<kPrecisionDouble, kPrecisionDouble> bicgstab(param, max_iteration, max_precision);
        bicgstab.solve();
    }
    else if (outputPrecision == QcuPrecision::kPrecisionSingle && iteratePrecision == QcuPrecision::kPrecisionSingle) {
        BiCGStabImpl<kPrecisionSingle, kPrecisionSingle> bicgstab(param, max_iteration, max_precision);
        bicgstab.solve();
    }
