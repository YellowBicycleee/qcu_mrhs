...
int main () {
    ...
    const     int single_vec_length = 1024 * 1024 * 12;
    ...
    cublas_arr_vec_norm(h_gpu_res_vec, 
                        ...
                        cublas_handle);
    timer.stop();
    cout << num_vecs << " vecs combined norm: cublas time      = " << timer.getElapsedTimeSecond() << endl;
    timer.start();
    // cublas coalesced calculation
    cublas_arr_vec_norm(h_gpu_res_vec, 
                        gpu_out, 
                        gpu_in, 
                        single_vec_length, 
                        ...
                        cublas_handle);
    timer.stop();
    cout << "coalesced norm of 1 vector: cublas time      = " << timer.getElapsedTimeSecond() << endl;
    timer.start();
    ...
    cublas_arr_vec_norm(h_gpu_res_vec, 
                        ...
                        cublas_handle);
    timer.stop();
    cout << num_vecs << " vectors separated norm: cublas time      = " << timer.getElapsedTimeSecond() << endl;
    ...
    my_function(my_h_gpu_res_vec, 
                ...
                cublas_handle);
    timer.stop();
    cout << num_vecs << " vecs combined norm: my_function time      = " << timer.getElapsedTimeSecond() << endl;
    ...
    my_function(my_h_gpu_res_vec, 
                ...
                cublas_handle);
    timer.stop();
    cout << "coalesced norm of 1 vector: my_function time      = " << timer.getElapsedTimeSecond() << endl;
    ...
    my_function(my_h_gpu_res_vec, 
                ...
                cublas_handle);
    timer.stop();
    cout << num_vecs << " vectors separated norm: my_function time      = " << timer.getElapsedTimeSecond() << endl;
