// Created by YellowBicycleee on 2024/12/14.
// This file use policy2 (combined residual) to solve.
...
bool BiCGStabImpl<OutputPrecision, IteratePrecision>::solve_odd_policy2() {
    ...
    using IterNormArgument =
        typename InteriorOperator::template ComplexNorm<OutputFloat, IterateFloat>::template ComplexNormArgument;
    ...
    OutputElementwiseDivArgument output_elementwise_div_arg {
        nullptr, nullptr, nullptr, 1 /* vec_len */
    };
